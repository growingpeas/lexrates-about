...
Somebody has to read fifteen official gazettes and notice when each one moves. **14 of the 20
regimes that have ever moved did so in the last twelve months, on 7 separate days**, against 39
days in the whole log. One country is a reminder in your calendar. Several is a standing job,
and this is that job, published as data.
...
all need the employee's own history, and that belongs in your engine, not in a reference feed.
